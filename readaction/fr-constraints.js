...
// Some elements are repeated several times to balance odds with other possibilites
const colors = [
    "bordeaux", "ocre", "vermillon", "indigo", "chlorophylle", "bleu givré",
...
const WC_CONSTRAINTS = {
  ...
  genre: [
    ...
    { value: "Scène de vie",            hint: "rien qu'un moment, sans grande intrigue" },
